...
public class InheritanceServie {
	
	

	// 상속 확인 예제
	public void ex1() { 
		// Person 을 상속 받은 Student가 Person 필드,메소드를 사용할 수 있는가?
		...
		// 부모에게 정의하면 상속받은 자식들은 모두 부모의 것을 그대로 받아서 쓸수 있음
	...
	public void ex3() {
		...
		emp.move(); // 오버라이딩 0 -> Employee의 메소드 수행
