...
public class Student extends Person{
	...
	// Student 클래스 Person 캘르 내용 (필드,메서드)을 추가하여 확장한다 
	// ***상속
	// extends : 확장하다, 연장하다 
	...
	public Student() {
		...
		// Student() 객체 생성시 
				...
				super(); // super() 생성자
				// 부모의 생성자를 호출하는 코드 
				// 반드시 자식생성자 최상단에 작성되어야한다
				// 부모의 생성자 실행(필드초기화 측정기능 수행)
			
				
				// * super() 생성자 때문에 
				// 자식 객체 내무에 부모 객체가 생성된다 
	...
	//	this.age = age;
		...
		super(name, age, nationality); // 부모의 생성자 중, 매개변수 변수 생성자 호출
